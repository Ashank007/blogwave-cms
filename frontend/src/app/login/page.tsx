...
const page = () => {
  return (
    <>
    <Box position='relative' bgImage={'/assets/underwaterbg.jpeg'} bgSize={'cover'} h={'100vh'} w={'100vw'}   filter=" brightness(0.6) contrast(1.3) saturate(0.9) drop-shadow(0px 0px 10px rgba(0, 0, 0, 1))">
      <ParticleCanvas/>
